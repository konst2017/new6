...
<?php foreach($hits as $hit): ?>
  <?php $search = ActiveForm::begin([
        ...
        ?>
<input type="text" value="<?=$hit->naim ?>" name="name2" class="inp1"> </p>

 <p><input type="radio" name="name1"  value="<?=$hit->perot ?>"><?=$hit->perot ?> </p>
  <p><input type="radio" name="name1" value="<?=$hit->wtorot ?>"><?=$hit->wtorot ?> </p>
 <p><input type="radio" name="name1" value="<?=$hit->tretot ?> "><?=$hit->tretot ?> </p>
